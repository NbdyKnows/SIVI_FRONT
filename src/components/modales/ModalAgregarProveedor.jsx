...
const ModalAgregarProveedor = ({ isOpen, onClose, onSave }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const nuevoProveedor = {
        id_proveedor: Date.now(), // ID temporal
  ...
  return (
    <div className="fixed inset-0 bg-transparent flex items-center justify-center z-50 p-4 animate-fade-in">
      <div className="bg-white rounded-xl shadow-2xl w-full max-w-md max-h-[90vh] overflow-y-auto border border-gray-200 transform animate-scale-in">
        {/* Header */}
